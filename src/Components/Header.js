    ...
    >
      <div className="max-w-[1200px] mx-auto flex items-center justify-between px-5 py-3">
        ...
        <nav className="flex items-center gap-6 md:gap-8">
          <Link
            to="/"
            className="hidden md:flex items-center gap-2 text-slate-body hover:text-slate-title transition-colors text-sm font-medium"
          >
          ...
          >
            ...
            <span className="hidden sm:inline">{localUser || BtnName}</span>
          </button>
          <Link
            to="/Cart"
